 ...
 //ongOptions select
  ...
  return (
    <div className="auth__container">
      ...
      {success && (
        <Swiper
          frase="Cuenta creada con éxito, Ahora inicia sesión"
          color="#005692"
          tipo="success"
        />
      )}
      ...
      {errorRegister && (
        <Swiper
          frase="El usuario posiblemente ya existe, No se pudo crear tu cuenta"
          color="#DD0C0C"
          tipo="error"
        />
      )}
      ...
      >
        {errorRegister ? (
          <p className="auth__error">El usuario ya existe</p>
        ) : (
          ""
        )}
        {success && (
          <p className="auth__sucesss">
        ...
        <div>
          ...
          {errors?.name?.type === "required" && (
            <p className="auth__error">Este campo es obligatorio</p>
          )}
          {errors?.name?.type === "minLength" && (
            <p className="auth__error">
              Tu nombre debe ser minímo de 2 caracterés
            </p>
          )}
          {errors?.name?.type === "maxLength" && (
            <p className="auth__error">
              Tu nombre debe ser máximo de 50 caracterés
            </p>
          )}
          <input
        ...
        <div>
          ...
          {errors?.lastname?.type === "required" && (
            <p className="auth__error"> Tu apellido es obligatorio</p>
          )}
          {errors?.lastname?.type === "maxLength" && (
            <p className="auth__error">
              Tu apellido debe ser máximo de 50 caracterés
            </p>
          )}
          <input
            className="auth__input"
        ...
        <div>
          ...
          {errors?.email?.type === "minLength" && (
            <p className="auth__error">
              Tu correo debe ser minímo de 3 caracterés
            </p>
          )}
          {errors?.email?.type === "maxLength" && (
            <p className="auth__error">
              Tu correo debe ser máximo de 40 caracterés
            </p>
          )}
          {errors?.email?.type === "pattern" && (
            <p className="auth__error">Debes escribir un correo válido</p>
          )}
          <input
            className="auth__input"
            type="email"
        ...
        <div>
          ...
          {errors?.password?.type === "minLength" && (
            <p className="auth__error">
              Tu contraseña debe ser minímo de 6 caracterés
            </p>
          )}
          {errors?.password?.type === "maxLength" && (
            <p className="auth__error">
              Tu contraseña debe ser máximo de 50 caracterés
            </p>
          )}
          {errors?.password?.type === "pattern" && (
            <p className="auth__error">
              Tu contraseña debe tener al menos un número y una letra
            </p>
          )}
          <input
            className="auth__input"
        ...
        <div>
          <label className="auth__label" htmlFor="birth_date">
            Fecha de nacimiento
          </label>
          ...
          {errors?.birth_date?.type === "validate" && (
            <p className="auth__error">Debe tener al menos 18 años</p>
          )}
          <input
            className="auth__input"
            type="date"
        ...
        <div>
          ...
          {errors?.phone?.type === "required" && (
            <p className="auth__error">El número de telefono es obligatorio</p>
          )}
        ...
        {/* Campo para el DNI */}
        <div>
          <label className="auth__label" htmlFor="DNI">
            DNI
          </label>
          ...
          {errors?.DNI?.type === "minLength" && (
            <p className="auth__error">
              Tu DNI debe ser minímo de 5 caracterés
            </p>
          )}
          {errors?.DNI?.type === "maxLength" && (
            <p className="auth__error">
              Tu DNI debe ser máximo de 8 caracterés
            </p>
          )}
          {errors?.DNI?.type === "pattern" && (
            <p className="auth__error">Debe ser un número valido de DNI</p>
          )}
          <input
            className="auth__input"
            type="text"
        ...
        <div>
          ...
          {errors?.profile_picture?.type === "pattern" && (
            <p className="auth__error">Debe ser un archivo de imagen</p>
          )}
          <input
            className="auth__input"
            type="file"
        ...
        <div>
          <label
            ...
            htmlFor="habitual_location_of_residence"
          >
            Lugar de residencia
          </label>
          {errors?.habitual_location_of_residence?.type === "required" && (
            <p className="auth__error">Este campo es obligatorio</p>
          )}
          <Controller
        ...
        <div>
          <label className="auth__label" htmlFor="geographical_area_residence">
            area de Localización
          </label>
          {errors?.geographical_area_residence?.type === "maxLength" && (
            <p className="auth__error">
              Tu area de localización debe ser máximo de 50 caracterés
            </p>
          )}
          <input
            className="auth__input"
            type="text"
            {...register("geographical_area_residence", { maxLength: 50 })} // Opcional
            id="geographical_area_residence"
            placeholder="Tu Localización"
          />
        </div>
        <div>
          ...
          {errors?.description?.type === "maxLength" && (
            <p className="auth__error">
              Tu descripcion debe ser máximo de 100 caracterés
            </p>
          )}
          <input
            className="auth__input"
            type="text"
            {...register("description", { maxLength: 100, required: true })} // Opcional
            id="description"
