...
const pendingApprove = (title , email) => {
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                       <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr>
                          <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;font-size:0px"><img src="https://fclnyeb.stripocdn.email/content/guids/CABINET_574ff77839dcd1cb610d8074d6caf01ba568bdaf7e9da6f91c669a75ede6ff70/images/warning256.png" alt="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none" width="100"></td>
                         </tr>
                         <tr>
                          <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:46px;font-style:normal;font-weight:bold;line-height:46px;color:#333333">Tu Publicación esta pendiente de aprobación</h1></td>
                         </tr>
                         <tr>
                          <td align="justify" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px;padding-left:40px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">¡Gracias por tu contribución!</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">​</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Hemos recibido tu reciente publicación titulada "${title}".&nbsp;</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Nuestro equipo de administradores revisará cuidadosamente tu publicación para garantizar que cumpla con nuestras políticas y estándares. Por favor, ten en cuenta que este proceso puede llevar algún tiempo, ya que queremos asegurarnos de que cada contribución sea apropiada y beneficiosa para nuestra comunidad.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Apreciamos tu paciencia y compromiso con nuestra causa. Tan pronto como tu publicación sea revisada y aprobada, recibirás una notificación y será compartida con todos los miembros de la plataforma.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Gracias nuevamente por ser parte activa de Fundación Potenciar Solidario. Esperamos con entusiasmo ver más iniciativas tuyas en el futuro.</p></td>
                         </tr>
                         <tr>
    ...
    transporter.sendMail({
        from: '"Tu publicacion se encuentra en revisión" <henrypfg8@gmail.com>', // address
        to: email, // list of receivers
        subject: `Publicación en revisión`, // Subject line
